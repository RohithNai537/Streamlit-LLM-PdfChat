...
def get_conversation_chain(vectorstore):
    ...
    prompt_template = """You are an intelligent assistant. Use the following pieces of context to answer the question in a detailed, structured, and well-explained manner. Provide insights and examples where possible.
...
st.set_page_config(page_title=" Navish.AI----Chat With Your Favorite PDF", page_icon="🏋️")
...
def main():
    load_dotenv()
    st.header("Navish.AI---Chat With Your Favorite PDF 🏋️")
